describe("Click Event of Login View", function() {
...
describe("In LoginView tests", function() {
    ...
    it("A function readUserData returns empty object without click event.", function() {
        var loginView;
    ...
    it("A function showError should show error message on failure login", function() {
        var loginView, response = {
            "status": 0,
            "message": "FAILURE",
            "version": "1.0.0",
            "data": "Can Not Found Given Model In Database",
            "debugData": null
        };
        loginView = new Notes.LoginView();
