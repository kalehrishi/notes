...
CREATE TABLE `NoteTags` (
  ...
  CONSTRAINT `fk_notes_noteId` FOREIGN KEY (`noteId`) REFERENCES `Notes` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_userTags_userTagId` FOREIGN KEY (`userTagId`) REFERENCES `UserTags` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `UserTags` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_users_userId_idx` (`userId`),
  CONSTRAINT `fk1_users_userId` FOREIGN KEY (`userId`) REFERENCES `Users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
